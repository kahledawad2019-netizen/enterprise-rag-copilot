...
class SyntheticLoader:
    ...
    def _load_contacts(self, data: GeneratedData) -> None:
        ...
        rows = [
            (
                self.customer_ids[c["_customer_index"]],
                c["tenant_id"],
                c["full_name"],
                c["email"],
                c["phone"],
    ...
    def _load_subscriptions(self, data: GeneratedData) -> None:
        ...
        rows = [
            (
                self.customer_ids[s["_customer_index"]],
                s["plan_id"],
                s["tenant_id"],
                s["started_on"],
                s["ended_on"],
        ...
        self.cursor.execute(
            "SELECT subscription_id FROM core.subscriptions ORDER BY subscription_id"
        )
    ...
    def _load_usage(self, data: GeneratedData) -> None:
        ...
        rows = [
            (
                self.customer_ids[u["_customer_index"]],
                u["product_id"],
                u["tenant_id"],
                u["usage_date"],
                u["active_users"],
    ...
    def _load_invoices(self, data: GeneratedData) -> None:
        ...
        rows = [
            (
                i["invoice_number"],
                self.customer_ids[i["_customer_index"]],
                self.subscription_ids[i["_subscription_index"]],
                i["tenant_id"],
                i["issue_date"],
                i["due_date"],
                i["period_start"],
    ...
    def _load_invoice_items(self, data: GeneratedData) -> None:
        ...
        rows = [
            (
                self.invoice_ids[it["_invoice_index"]],
                it["product_id"],
                it["plan_id"],
                it["description"],
                it["quantity"],
    ...
    def _load_payments(self, data: GeneratedData) -> None:
        ...
        rows = [
            (
                self.invoice_ids[p["_invoice_index"]],
                self.customer_ids[p["_customer_index"]],
                p["tenant_id"],
                p["payment_date"],
                p["amount"],
                p["currency_code"],
    ...
    def _load_refunds(self, data: GeneratedData) -> None:
        ...
        rows = [
            (
                self.invoice_ids[r["_invoice_index"]],
                self.payment_ids.get(r["_payment_index"]),
                self.customer_ids[r["_customer_index"]],
                r["tenant_id"],
                r["refund_date"],
                r["amount"],
                r["currency_code"],
    ...
    def _load_tickets(self, data: GeneratedData) -> None:
        ...
        rows = [
            (
                t["ticket_number"],
                self.customer_ids[t["_customer_index"]],
                t["product_id"],
                t["tenant_id"],
                t["opened_at_utc"],
                t["first_response_at_utc"],
                t["resolved_at_utc"],
                t["closed_at_utc"],
                t["priority"],
                t["category"],
    ...
    def _load_ticket_events(self, data: GeneratedData) -> None:
        ...
        rows = [
            (
                self.ticket_ids[e["_ticket_index"]],
                e["tenant_id"],
                e["event_at_utc"],
                e["event_type"],
                e["actor_type"],
    ...
    def _load_sla_breaches(self, data: GeneratedData) -> None:
        ...
        rows = [
            (
                self.ticket_ids[b["_ticket_index"]],
                self.customer_ids[b["_customer_index"]],
                b["sla_policy_id"],
                b["tenant_id"],
                b["breach_type"],
                b["target_minutes"],
    ...
    def _load_incident_impact(self, data: GeneratedData) -> None:
        ...
        rows = [
            (
                self.incident_ids[i["_incident_index"]],
                self.customer_ids[i["_customer_index"]],
                i["tenant_id"],
                i["impact_level"],
                i["downtime_minutes"],
    ...
    def _load_health(self, data: GeneratedData) -> None:
        ...
        rows = [
            (
                self.customer_ids[h["_customer_index"]],
                h["tenant_id"],
                h["snapshot_date"],
                h["health_score"],
                h["usage_score"],
